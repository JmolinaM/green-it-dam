...
\usepackage{xcolor}
\usepackage{colortbl}
% Colores para la matriz de correspondencia currículo–prácticas
\definecolor{practica0}{HTML}{AED6F1}
\definecolor{practica1}{HTML}{ABEBC6}
\definecolor{practica2}{HTML}{82E0AA}
\definecolor{practica3}{HTML}{F9E79F}
\definecolor{practica4}{HTML}{52BE80}
% TikZ para figuras
\usepackage{tikz}
...
% Ficha técnica de práctica Green IT
\newcommand{\fichapractica}[8]{%
  % #1 código (P0), #2 título, #3 RA, #4 CE, #5 metodología, #6 duración, #7 herramientas, #8 entregable
  \begin{tcolorbox}[
    enhanced,
    breakable,
    ...
    title={\textbf{#1} — \textit{#2}},
    left=6pt, right=6pt, top=4pt, bottom=4pt,
    boxrule=0.8pt,
    arc=4pt
  ]
  \begin{tabular}{@{}p{3.2cm}p{10.5cm}@{}}
    \textbf{RA asociado}   & #3 \\[4pt]
    \textbf{CE integrado}  & #4 \\[4pt]
    \textbf{Metodología}   & #5 \\[4pt]
    \textbf{Duración}      & #6 \\[4pt]
    \textbf{Principio GSE} & #7 \\[4pt]
    \textbf{Entregable}    & #8 \\
  \end{tabular}
  \end{tcolorbox}
}
