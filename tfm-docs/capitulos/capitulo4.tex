...
Los equipos trabajan de forma autónoma. Si un equipo lleva más de 10 minutos sin avanzar, el Analista de datos puede pedir al docente \textbf{una sola pregunta socrática} de desbloqueo (\textit{``¿Qué atributo del objeto crece cada vez que llega un dato nuevo?''}, \textit{``Si ejecutáis el script para n=100 y para n=1000, ¿qué línea de la traza cambia más?''}).
