...
\fichapractica{P2}{El servidor que no para de crecer}
  ...
  {Se ha analizado el impacto en el consumo de memoria de las decisiones de instanciación de objetos, cuantificando con tracemalloc el coste de distintas arquitecturas de clases}
...
El equipo lee \texttt{sensor\_monitor.py} completo sin ejecutar (5 min), luego ejecuta \texttt{stress\_test.py} para n=100, 500, 1000. El Analista de datos copia los datos; el Portavoz lee las líneas con mayor \texttt{+KiB} en tracemalloc. El Programador/a puede ejecutar variaciones libres para verificar hipótesis.
