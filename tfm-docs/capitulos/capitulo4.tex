...
\subsubsection{Sesión 1 (50 min): \textit{La misión: ¿qué sabemos y qué necesitamos averiguar?}}
...
El docente forma los equipos de 3 (mezcla de perfiles, no afinidad libre), asigna los roles iniciales y reparte el dosier impreso y el código sin explicar el problema.


\begin{quote}
\textit{"Tenéis el caso de un cliente. Leedlo en equipo. A los 5 minutos os pregunto qué entendisteis."}
\end{quote}


\textbf{(15 min) Análisis ABP de la misión: Ficha de Equipo P2 (parte 1)}


Cada equipo trabaja con la misión y completa:

\begin{itemize}
\item \textbf{Lo que sabemos} (hechos de la misión)
...
El docente circula respondiendo con preguntas: \textit{"¿Qué os dice la misión sobre eso?"}, \textit{"¿Qué haría un programador que recibe este código por primera vez?"}
...
\begin{enumerate}
\item Ficha P2: Parte 1 (análisis de la misión: sabemos / no sabemos / hipótesis)
