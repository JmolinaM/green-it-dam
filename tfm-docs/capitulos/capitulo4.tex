...
\subsubsection{Sesión 1 (50 min): \textit{El enunciado: ¿qué sabemos y qué necesitamos averiguar?}}
...
El docente forma los equipos de 3 (mezcla de perfiles, no afinidad libre), asigna los roles iniciales y reparte el enunciado impreso y el código sin explicar el problema.


\begin{quote}
\textit{"Tenéis el enunciado del caso. Leedlo en equipo. A los 5 minutos os pregunto qué entendisteis."}
\end{quote}


\textbf{(15 min) Análisis ABP del enunciado: Ficha de Equipo P2 (parte 1)}


Cada equipo trabaja con el enunciado y completa:

\begin{itemize}
\item \textbf{Lo que sabemos} (hechos del enunciado)
...
El docente circula respondiendo con preguntas: \textit{"¿Qué os dice el enunciado sobre eso?"}, \textit{"¿Qué haría un programador que recibe este código por primera vez?"}
...
\begin{enumerate}
\item Ficha P2: Parte 1 (análisis del enunciado: sabemos / no sabemos / hipótesis)
