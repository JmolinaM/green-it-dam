...
\subsubsection{Sesión 1 (50 min): \textit{El encargo: ¿qué sabemos y qué necesitamos averiguar?}}
...
El docente forma los equipos de 3 (mezcla de perfiles, no afinidad libre), asigna los roles iniciales y reparte el encargo impreso y el código sin explicar el problema.


\begin{quote}
\textit{"Tenéis un encargo de un cliente. Leedlo en equipo. A los 5 minutos os pregunto qué entendisteis."}
\end{quote}


\textbf{(15 min) Análisis ABP del encargo: Ficha de Equipo P2 (parte 1)}


Cada equipo trabaja con el encargo y completa:

\begin{itemize}
\item \textbf{Lo que sabemos} (hechos del encargo)
...
El docente circula respondiendo con preguntas: \textit{"¿Qué os dice el encargo sobre eso?"}, \textit{"¿Qué haría un programador que recibe este código por primera vez?"}
...
\begin{enumerate}
\item Ficha P2: Parte 1 (análisis del encargo: sabemos / no sabemos / hipótesis)
