...
Los equipos trabajan de forma autónoma. Si un equipo lleva más de 10 minutos sin avanzar, el Analista de datos puede pedir al docente \textbf{una sola pregunta socrática} de desbloqueo (\textit{``¿Qué pasa con el tamaño de \texttt{\_historial} cuando doblas \texttt{n}?''}, \textit{``¿Cuántos objetos \texttt{ConfiguracionApp} se crean para n=1000?''}).
