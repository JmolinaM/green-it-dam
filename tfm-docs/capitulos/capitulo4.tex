...
\begin{tcbraster}[
  ...
  title code={%
    \path[fill=\kvtcb@backcolortitle,rounded corners=4pt]
...
\begin{tcolorbox}[
  title={P0},
  colbacktitle=practica0!80!black,
  colframe=practica0!70!black,
  colback=practica0!10
]
  \centering
  \small\textbf{Concienciar}\\[4pt]
  \footnotesize\textit{¿Cuánto contamina tu código?}\\[6pt]
  \begin{tabular}{@{}l@{\ }l@{}}
    \tiny RA: & \tiny Prev. RA1 \\
    \tiny Mét.: & \tiny Jigsaw \\
    \tiny GSE: & \tiny Magnitud \\
    \tiny Ses.: & \tiny 2 \\
  \end{tabular}
\end{tcolorbox}
% P1
\begin{tcolorbox}[
  title={P1},
  colbacktitle=practica1!75!black,
  colframe=practica1!65!black,
  colback=practica1!15
]
  \centering
  \small\textbf{Medir}\\[4pt]
  \footnotesize\textit{¿Cuánto pesa tu algoritmo?}\\[6pt]
  \begin{tabular}{@{}l@{\ }l@{}}
    \tiny RA: & \tiny RA3 \\
    \tiny Mét.: & \tiny ABP individual \\
    \tiny GSE: & \tiny P.\,I \\
    \tiny Ses.: & \tiny 2 \\
  \end{tabular}
\end{tcolorbox}
...
\begin{tcolorbox}[
  title={P2},
  colbacktitle=practica2!75!black,
  colframe=practica2!65!black,
  colback=practica2!15
]
  \centering
  \small\textbf{Analizar}\\[4pt]
  \footnotesize\textit{El servidor que no para de crecer}\\[6pt]
  \begin{tabular}{@{}l@{\ }l@{}}
    \tiny RA: & \tiny RA4 \\
    \tiny Mét.: & \tiny ABP grupal \\
    \tiny GSE: & \tiny P.\,III \\
    \tiny Ses.: & \tiny 3 \\
  \end{tabular}
\end{tcolorbox}
...
\begin{tcolorbox}[
  title={P3},
  colbacktitle=practica3!75!black,
  colframe=practica3!65!black,
  colback=practica3!15
]
  \centering
  \small\textbf{Optimizar}\\[4pt]
  \footnotesize\textit{Datos que cuestan energía}\\[6pt]
  \begin{tabular}{@{}l@{\ }l@{}}
    \tiny RA: & \tiny RA5 \\
    \tiny Mét.: & \tiny ABP individual \\
    \tiny GSE: & \tiny P.\,I \\
...
\begin{tcolorbox}[
  title={P4},
  colbacktitle=practica4!75!black,
  colframe=practica4!65!black,
  colback=practica4!15
]
  \centering
  \small\textbf{Actuar}\\[4pt]
  \footnotesize\textit{La cola verde}\\[6pt]
  \begin{tabular}{@{}l@{\ }l@{}}
    \tiny RA: & \tiny RA9 \\
    \tiny Mét.: & \tiny ABP grupal \\
    \tiny GSE: & \tiny P.\,II \\
...
\end{tcolorbox}
\end{tcbraster}
\caption*{\footnotesize\textit{Secuencia P0--P4: 14 sesiones (11,7\,h) en MP0485 Programación, CFGS DAM 1.º curso. GSE: principio de Green Software Engineering trabajado.}}
...
\fichapractica{P0}{¿Cuánto contamina tu código?}
  ...
  {Sin instalación de software (IEA, Electricity Maps, Website Carbon Calculator, PNAV), papel y calculadora}
...
\fichapractica{P1}{¿Cuánto pesa tu algoritmo?}
  ...
  {ABP individual}
  {2 sesiones $\times$ 50 min}
  {CodeCarbon (\texttt{pip install codecarbon}), cProfile (stdlib), Python 3.10+, VS Code}
...
\fichapractica{P2}{El servidor que no para de crecer}
  ...
  {\texttt{tracemalloc} (stdlib), modelo CO$_2$ manual, VS Code}
...
\fichapractica{P3}{Datos que cuestan energía}
  ...
  {ABP individual}
  {3 sesiones $\times$ 50 min}
  {CodeCarbon, tracemalloc (stdlib), pandas, Python 3.10+, VS Code}
...
\fichapractica{P4}{La cola verde}
  ...
  {CodeCarbon, Electricity Maps API (CSV simulado), Python 3.10+, VS Code, pytest}
