...
Cada práctica se evalúa mediante una rúbrica analítica que incluye un \textbf{Criterio Green IT} específico. Las rúbricas tienen función formativa: el alumnado las recibe al inicio de cada práctica y las usa como guía de autoevaluación antes de entregar.
...
\hline
\textbf{Criterio Green IT} & Consigue \textgreater{}90 \% de reducción en CO$_2$ entre versiones; extrapola el ahorro a 10 M peticiones/día con cifras correctas & Mide y consigue reducción \textgreater{}50 \% con justificación técnica parcial & Mide ambas versiones pero la diferencia es \textless{}50 \% o no justifica la causa & No mide con CodeCarbon o los datos son metodológicamente inválidos \\
\hline
...
\begin{tabular}{|p{3cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
\hline
\textbf{Criterio} & \textbf{Insuficiente (0–4)} & \textbf{Suficiente (5–6)} & \textbf{Notable (7–8)} & \textbf{Sobresaliente (9–10)} \\
\hline
\textbf{Diagnóstico técnico} (25\%) & No identifica la causa del crecimiento & Identifica al menos una causa, sin apoyo de datos & Identifica la causa principal con dato de tracemalloc & Identifica y cuantifica todas las causas, señalando qué líneas las producen \\
\hline
\textbf{Solución y justificación} (25\%) & La refactorización no reduce el crecimiento o no está justificada & Reduce la RAM con una solución funcional, sin argumentar la elección & Justifica la solución con datos y menciona el patrón arquitectónico aplicado & Justifica la solución, contrasta con alternativas y argumenta el trade-off asumido \\
\hline
\textbf{Datos y medición} (25\%) & No presenta tabla comparativa & Tabla antes/después para un solo valor de n & Tabla para $n\in\{100,500,1000\}$ con \% de reducción & Tabla completa + estimación CO$_2$eq + extrapolación a 8 h con cálculo explícito \\
\hline
\textbf{Reflexión y transferencia} (25\%) & Reflexión ausente o de una línea & Reflexión genérica sin conexión con POO & Conecta la decisión con principios POO (encapsulamiento, responsabilidad única) & Transfiere el aprendizaje a un contexto profesional nuevo con argumentos de diseño \\
\hline
\end{tabular}
...
\hline
\textbf{Tests unitarios} & Suite de ≥ 5 tests con \texttt{unittest.mock.patch}; todos pasan; incluye test de regresión para el orden de prioridad & Suite de 3-4 tests, todos pasan; falta test de orden de prioridad o historial & Suite de 1-2 tests que solo verifican el caso básico & Sin tests o tests que dependen de la intensidad real de la red \\
\hline
\end{tabular}
