...
\end{tcolorbox}
\begin{tcolorbox}[
  title={Principio II -- Carbon-Aware Computing},
...
\end{tcolorbox}
\begin{tcolorbox}[
  title={Principio III -- Hardware eficiente},
  ...
  Software ligero (menos RAM/CPU) \textbf{prolonga la vida \'util}
  del hardware y amortiza su huella de fabricaci\'on.
  \vspace{6pt}\par
  \centering
  \begin{tabular}{ll}
...
\begin{tcolorbox}[
  ...
  de la Green Software Foundation cuantifica el impacto
